...
#스프라이트 불러오기
character = pygame.image.load("C:\\Users\\sbsh\\Videos\\Desktop\\pygame.basic-main\\pygame.basic-main\\Character.png")
...
# 적 캐릭터
enemy = pygame.image.load("C:\\Users\\sbsh\\Videos\\Desktop\\pygame.basic-main\\pygame.basic-main\\Enemy.png")
...
enemy_y_pos = (screen_height / 2) - (enemy_height / 2) #화면 세로 절반 크기에 해당하는 곳에 위치
...
while running:
    dt = clock.tick(60) #게임 화면 초당 프레임 수를 설정
